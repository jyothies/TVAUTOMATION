...
- group "Your Personal Details":
  ...
  - textbox "* First Name": Madyson
  - text: "* Last Name"
  - textbox "* Last Name": Hane
  - text: "* E-Mail"
  - textbox "* E-Mail": Jackie_Pacocha@hotmail.com
  - text: "* Telephone"
  - textbox "* Telephone"
  - text: Telephone must be between 3 and 32 characters!
- group "Your Password":
  - text: Your Password * Password
  - textbox "* Password": F31I_avAe_Y4Ae2
  - text: "* Password Confirm"
  - textbox "* Password Confirm": F31I_avAe_Y4Ae2
- group "Newsletter":
