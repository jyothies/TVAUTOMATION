...
- group "Your Personal Details":
  ...
  - textbox "* First Name": Russel
  - text: "* Last Name"
  - textbox "* Last Name": Brakus
  - text: "* E-Mail"
  - textbox "* E-Mail": Toney_Leuschke26@gmail.com
  - text: "* Telephone"
  - textbox "* Telephone"
  - text: Telephone must be between 3 and 32 characters!
- group "Your Password":
  - text: Your Password * Password
  - textbox "* Password": 2wJxfwSubp8bM2l
  - text: "* Password Confirm"
  - textbox "* Password Confirm": 2wJxfwSubp8bM2l
- group "Newsletter":
